"""Streamlit UI for the vacation planner crew."""
...
st.markdown(
    '<h1 class="main-header">✈️ Personal AI Vacation Planner</h1>',
    unsafe_allow_html=True,
)
st.markdown(
    '<p class="subtitle">Plan your perfect vacation with AI-powered research and itinerary planning!</p>',
    unsafe_allow_html=True,
)
...
with col2:
    with st.form("vacation_form"):
        ...
        submitted = st.form_submit_button(
            "🚀 Plan My Dream Vacation", type="primary", use_container_width=True
        )
